<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="info.aspx.cs" Inherits="SummerCamp.info" %>
                                                ...
                                                <div class="item-inner">
                                                    ...
                                                    <div class="item-after">
                                                        ...
                                                        <asp:DropDownList ID="drp_gread" runat="server" Width="100%" Font-Size="14px" ForeColor="#666666">
                                                            ...
                                                            <asp:ListItem Value="-99">---请选择在读年级---</asp:ListItem>
                                                       <%--     <asp:ListItem Value="-3">K0</asp:ListItem>
                                                            <asp:ListItem Value="-2">K1</asp:ListItem>
                                                            <asp:ListItem Value="-1">K2</asp:ListItem>
                                                            <asp:ListItem Value="0">K3</asp:ListItem>--%>
                                                            ...
                                                            <asp:ListItem Value="11">十年级G11</asp:ListItem>
                                                            <asp:ListItem Value="12">十年级G12</asp:ListItem>--%>
                                                        </asp:DropDownList>
                                                    </div>
                                                </div>
                                            </li>
