<%@ Page   EnableViewStateMac="false" Language="C#" AutoEventWireup="true" CodeBehind="summercampuseradmin.aspx.cs" Inherits="SummerCamp.summercampuseradmin" %>
        ...
        <ContentTemplate>
            ...
            <tr style="height:40px; background-color:#CC5599;">
                <td colspan="19" style="text-align:center; width:100%;">
                    <span style="color:White; font-size:20px;">2024幼儿园夏令营(校外)</span>
                </td>
            </tr>
